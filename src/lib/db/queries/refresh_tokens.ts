...
export async function createRefreshToken(token: string, userId: string, expiresAt: number) {
...
export async function updateRefreshToken(token: string, revokedAt: number) {
